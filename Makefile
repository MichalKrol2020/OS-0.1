FILES = ./build/kernel.asm.o ./build/kernel.o ./build/stdio.o # whenever the all command is run, we depend on the files and it will go through the files and resolve the labels
INCLUDES = -I./src
